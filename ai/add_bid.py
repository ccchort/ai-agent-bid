    ...
    context = [
                {
                    ...
                    'text': (
                        ...
                        "- 'Обращение': точная передача обращения без обобщения, не перефразируй, не придумывай, просто передай сообщение в исходном виде, регестрируй обращение, как есть. Если текст сотиот просто из 'спасибо', 'благодарю' без заявки, возвращай None\n"
...
if __name__ == "__main__":
    result = asyncio.run(generate({'id': 16, 'user_id': 1414952718, 'platform': 'Max', 'accumulated_text': 'ок)', 'created_at': '2026-07-21 22:33:05 +0400', 'last_message_at': '2026-07-21 22:44:33 +0400', 'client_name': 'Бухгалтерия ИП Ватрушкин'}))
    print(result)
