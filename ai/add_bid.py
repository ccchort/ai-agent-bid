    ...
    context = [
                {
                    ...
                    'text': (
                        ...
                        "- 'Обращение': точная передача обращения без обобщения, не перефразируй, не придумывай, просто передай сообщение в исходном виде, регестрируй обращение, как есть\n"
